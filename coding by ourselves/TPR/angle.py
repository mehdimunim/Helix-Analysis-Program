...
def another_tpr(ref_angle, incrot, axisdir):
    """
    Calculate angle between ref_angle and direction
    """
    # Some sort of rotational matrix A
    nresu = nres - 2*incrot
    ...
    for residue in range(1 + incrot, nres-incrot):
        ...
        turn_change = angle(perpendicular_before, axisdir, perpendicular_after)
           if (turnchange < 0):
                turnchange += 2*PI
